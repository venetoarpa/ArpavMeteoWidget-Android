...
/**
 * Class used to show the simple widgets configuration
 * @author Luca
 *
 */
public class SimpleWidgetConfiguration extends PreferenceActivity implements
            ...
            public void onClick(View v) {
                ...
                if (prefs.getString("city_zone", "").equals("geo")) {
                    ...
                    if(netInfo != null && netInfo.isConnectedOrConnecting()) {
                        ...
                        Controller.getInstance().updateBulletinAlarm(getApplicationContext(), "s");
                        Controller.getInstance().updateWidgetAlarm(getApplicationContext(), "s");
                        finish();
                    }
                    else {
                    ...
                    Controller.getInstance().updateSimpleWidgetFromConfiguration(getApplicationContext(), mAppWidgetId, listPreference.getEntry().toString());
                    Controller.getInstance().updateBulletinAlarm(getApplicationContext(), "s");
                    Controller.getInstance().updateWidgetAlarm(getApplicationContext(), "s");
                    finish();
                }
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences,
        ...
        try {
            if (sharedPreferences.getString(key, "0").equals("new")) {
                ...
                Intent myIntent = new Intent(SimpleWidgetConfiguration.this, Provinces.class);
                SimpleWidgetConfiguration.this.startActivityForResult(myIntent, 0);
            }
        }
